                ...
                while (!validChoice)
                {
                    ...
                    while (loggedInCustomer.PasswordAttempts < maxPasswordAttempts)
                    {
                        ...
                        else
                        {
                            ...
                            Console.WriteLine($"Incorrect password. You have {maxPasswordAttempts - loggedInCustomer.PasswordAttempts} attempts remaining.");
                        }
                    }
                    ...
                    {
                        Console.WriteLine("You have used all of your password attempts. Your account has been locked. Please contact support to unlock your account.");
                        Console.ReadKey();
